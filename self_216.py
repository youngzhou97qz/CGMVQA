...
mod_imag, mod_ques, mod_answ, mod_dict = balance_data(0,0,3200,500)
mod_yn_imag, mod_yn_ques, mod_yn_answ, mod_yn_dict = balance_data(0,0,3200,500,mode='yn')
pla_imag, pla_ques, pla_answ, pla_dict = balance_data(3200,500,6400,1000)
org_imag, org_ques, org_answ, org_dict = balance_data(6400,1000,9600,1500)
abn_yn_imag, abn_yn_ques, abn_yn_answ, abn_yn_dict = balance_data(9600,1500,12792,2000,mode='yn')
...
test_imag, test_ques, test_answ = extract_data(test_text_file,0,500)
...
mod_result1, mod_loss1 = train_model(mod_model1().to(device),mod_imag[550:],mod_ques[550:],mod_answ[550:],mod_imag[:550],mod_ques[:550],mod_answ[:550],'mod_1',2,0,125,False,mod_dict_op)
mod_result2, mod_loss2 = train_model(mod_model2().to(device),mod_imag[:800]+mod_imag[1350:],mod_ques[:800]+mod_ques[1350:],mod_answ[:800]+mod_answ[1350:],mod_imag[800:1350],mod_ques[800:1350],mod_answ[800:1350],'mod_2',2,0,125,False,mod_dict_op)
mod_result3, mod_loss3 = train_model(mod_model3().to(device),mod_imag[:-550],mod_ques[:-550],mod_answ[:-550],mod_imag[-550:],mod_ques[-550:],mod_answ[-550:],'mod_3',2,0,125,False,mod_dict_op)
mod_loss = [mod_loss1,mod_loss2,mod_loss3]

mod_yn_result1, mod_yn_loss1 = train_model(mod_yn_model1().to(device),mod_yn_imag[300:],mod_yn_ques[300:],mod_yn_answ[300:],mod_yn_imag[:300],mod_yn_ques[:300],mod_yn_answ[:300],'mod_yn_1',2,0,125,True,mod_yn_dict_op)
mod_yn_result2, mod_yn_loss2 = train_model(mod_yn_model2().to(device),mod_yn_imag[:500]+mod_yn_imag[800:],mod_yn_ques[:500]+mod_yn_ques[800:],mod_yn_answ[:500]+mod_yn_answ[800:],mod_yn_imag[500:800],mod_yn_ques[500:800],mod_yn_answ[500:800],'mod_yn_2',2,0,125,True,mod_yn_dict_op)
mod_yn_result3, mod_yn_loss3 = train_model(mod_yn_model3().to(device),mod_yn_imag[:-300],mod_yn_ques[:-300],mod_yn_answ[:-300],mod_yn_imag[-300:],mod_yn_ques[-300:],mod_yn_answ[-300:],'mod_yn_3',2,0,125,True,mod_yn_dict_op)

pla_result1, pla_loss1 = train_model(pla_model1().to(device),pla_imag[1050:],pla_ques[1050:],pla_answ[1050:],pla_imag[:1050],pla_ques[:1050],pla_answ[:1050],'pla_1',2,125,250,False,pla_dict_op)
pla_result2, pla_loss2 = train_model(pla_model2().to(device),pla_imag[:1600]+pla_imag[2650:],pla_ques[:1600]+pla_ques[2650:],pla_answ[:1600]+pla_answ[2650:],pla_imag[1600:2650],pla_ques[1600:2650],pla_answ[1600:2650],'pla_2',2,125,250,False,pla_dict_op)
pla_result3, pla_loss3 = train_model(pla_model3().to(device),pla_imag[:-1050],pla_ques[:-1050],pla_answ[:-1050],pla_imag[-1050:],pla_ques[-1050:],pla_answ[-1050:],'pla_3',2,125,250,False,pla_dict_op)
pla_loss = [pla_loss1,pla_loss2,pla_loss3]

org_result1, org_loss1 = train_model(org_model1().to(device),org_imag[1000:],org_ques[1000:],org_answ[1000:],org_imag[:1000],org_ques[:1000],org_answ[:1000],'org_1',2,250,375,False,org_dict_op)
org_result2, org_loss2 = train_model(org_model2().to(device),org_imag[:1500]+org_imag[2500:],org_ques[:1500]+org_ques[2500:],org_answ[:1500]+org_answ[2500:],org_imag[1500:2500],org_ques[1500:2500],org_answ[1500:2500],'org_2',2,250,375,False,org_dict_op)
org_result3, org_loss3 = train_model(org_model3().to(device),org_imag[:-1000],org_ques[:-1000],org_answ[:-1000],org_imag[-1000:],org_ques[-1000:],org_answ[-1000:],'org_3',2,250,375,False,org_dict_op)
...
abn_yn_result1, abn_yn_loss1 = train_model(abn_yn_model1().to(device),abn_yn_imag[30:],abn_yn_ques[30:],abn_yn_answ[30:],abn_yn_imag[:30],abn_yn_ques[:30],abn_yn_answ[:30],'abn_yn_1',2,375,500,True,abn_yn_dict_op)
abn_yn_result2, abn_yn_loss2 = train_model(abn_yn_model2().to(device),abn_yn_imag[:50]+abn_yn_imag[80:],abn_yn_ques[:50]+abn_yn_ques[80:],abn_yn_answ[:50]+abn_yn_answ[80:],abn_yn_imag[50:80],abn_yn_ques[50:80],abn_yn_answ[50:80],'abn_yn_2',2,375,500,True,abn_yn_dict_op)
abn_yn_result3, abn_yn_loss3 = train_model(abn_yn_model3().to(device),abn_yn_imag[:-30],abn_yn_ques[:-30],abn_yn_answ[:-30],abn_yn_imag[-30:],abn_yn_ques[-30:],abn_yn_answ[-30:],'abn_yn_3',2,375,500,True,abn_yn_dict_op)
...
result_file = '/home/'+user+'/CRG/self/2019_self_216.csv'
...
# evaluation
gt_file_path = '/home/'+user+'/CRG/result/2019_gt.csv'
evaluator = evaluation.VqaMedEvaluator(gt_file_path)
submission_file_path = '/home/'+user+'/CRG/result/2019_submit.csv'
result = evaluator._evaluate(submission_file_path)
print(result)
submission_file_path = '/home/'+user+'/CRG/self/2019_self_class.csv'
result = evaluator._evaluate(submission_file_path)
print(result)
submission_file_path = '/home/'+user+'/CRG/self/2019_self_216.csv'
result = evaluator._evaluate(submission_file_path)
print(result)